...
import HB450 from "../public/Images/HB2504x.png"
          ...
          <div className="container-fluid p-4">
            <div className="row gx-4">
              <div className="c0l-12 col-lg-4 p-2">
                <div className="row gy-4">
                  <div className="col-12">
                    <p className="text-header0 text-center text-lg-start">Cadie&apos;s Dark Wildflower Liquid Honey - 450g</p>
              ...
              <div className="col-12 col-lg-4 d-flex align-items-center justify-content-center mt-4 mt-lg-0">
                <Image src={HB450} alt="product1" className="productImg2 img-fluid" height={450}  width={360}/>
              </div>
                ...
                <div className="row gy-5">
                  <div className="col-12">
                    <div className="row">
                        ...
                        <div className="col-4">
                          <Link href="/honey">
                            <button className="formBtn2">150g</button>
                          </Link>
                        </div>
                        <div className="col-4">
                          <button className="formBtn" disabled>450g</button>
                        </div>
                        <div className="col-4">
                          <Link href="/honey1Kg">
