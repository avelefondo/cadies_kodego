...
import HB1L from "../public/Images/HB1L4x.png"
          ...
          <div className="container-fluid p-4">
            <div className="row gx-4">
              ...
              <div className="col-12 col-lg-4 d-flex align-items-center justify-content-center mt-4 mt-lg-0">
                <Image src={HB1L} alt="product1" height={600} width={150} />
              </div>
                ...
                <div className="row gy-5">
                  <div className="col-12">
                    <div className="row">
                        ...
                        <div className="col-4">
                          <Link href="/honey1Kg">
                            <button className="formBtn" disabled>1.3Kg</button>
                          </Link>
                        </div>
                    </div>
                  </div>
                  <div className="col-12">
                    <p className="text-header0">1,400.00php</p>
                  </div>
